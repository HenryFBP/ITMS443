			...
			if(select.prev('span.selectbox').length<1) {
				function doSelect() {
					...
					var ddlist='';for(i=0;i<option.length;i++) {
						...
						if(option.eq(i).is(':disabled'))selected=disabled;ddlist+='<li'+selected+'>'+option.eq(i).text()+'</li>';
					}
					...
					var liHeight=li.outerHeight();var position=dropdown.css('top');
					dropdown.hide();divSelect.click(function() {
